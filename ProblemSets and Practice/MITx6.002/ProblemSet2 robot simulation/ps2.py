...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        self.Rectroom = dict((((x,y)),0) for x in range(width) for y in range(height))
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """        
        self.Rectroom[(int(pos.x), int(pos.y))] = 1
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return int(sum(self.Rectroom.values()))
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.initialdirection = random.randint(0,359)
        self.room.cleanTileAtPosition(self.initialposition)
