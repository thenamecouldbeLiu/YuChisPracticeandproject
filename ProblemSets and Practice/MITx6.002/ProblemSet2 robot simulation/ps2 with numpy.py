...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        self.Rectroom = np.zeros((self.width, self.height))
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return int(np.sum(self.Rectroom))
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.initialdirection = random.randint(0,360)
    ...
    def setRobotDirection(self, direction):
        ...
        """
        if type(direction)!= int or direction not in range(360):
            raise ValueError
        else:
